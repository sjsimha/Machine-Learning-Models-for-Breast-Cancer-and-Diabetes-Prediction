...
def run():
    ...
    #           Validation Set Average Precision score ~0.87
    ...
    # Observations
    #   Entropy produced significantly better average precision score, therefore choose entropy and its
    #   associated best ccp_alpha
    clf.criterion = 'entropy'
    clf.ccp_alpha = 0.0149
